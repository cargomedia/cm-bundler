...
module.exports = function(patterns, withSourceMaps) {
  var done = 0;
  var filesIn = new ConcatFiles(withSourceMaps, 'bundle.js', '\n');
  var filesConcat = new ConcatFiles(withSourceMaps, 'concat.js', '\n');
  ...
  function addSourcemaps() {
    return condition(withSourceMaps, function() {
  ...
  function merge() {
    if (2 === ++done) {
      var result = new ConcatFiles(withSourceMaps, 'merged.js', '\n');
      ...
      if (withSourceMaps && result.sourceMap) {
